...
const recordingsData = require('./fixtures/recordings.json')
const eventsPageInfo = require('./fixtures/pageInfo.json')

class RecordingsFilterForm extends Component {
    constructor(props) {
        super(props);
...
class SensorRecords extends Component {
    ...
    render() {
        // const recordings = /*this.props.*/recordingsData
                    ...
                    <Col>
                        ...
                        <Card>
                            ...
                            <CardBody>
                                ...
                                <BootstrapTable keyField='id' data={ this.state.recordingsData } columns={ columns } filter={ filterFactory() }  pagination={ paginationFactory() }/>
                                {/* <PagingButtons pageInfo={pageInfo} /> */}
                            </CardBody>
                        </Card>
                    </Col>
